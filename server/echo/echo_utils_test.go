...
func GetTasksList(serve server_echo.Server, querystring string) (error, *httptest.ResponseRecorder) {
...
func PostNewTask(serve server_echo.Server) (todo.Task, error, *httptest.ResponseRecorder) {
	task := todo.Task{
...
func PutTask(task todo.Task, serve server_echo.Server) (todo.Task, *httptest.ResponseRecorder, error) {
	input := strings.NewReader(fmt.Sprintf("description=%s", task.Description))
...
func ToggleTaskStatus(task todo.Task, serve server_echo.Server) (todo.Task, *httptest.ResponseRecorder, error) {
...
func DeleteTask(task todo.Task, serve server_echo.Server) (*httptest.ResponseRecorder, error) {
...
func GetUpdateTaskForm(task todo.Task, serve server_echo.Server) (*httptest.ResponseRecorder, error) {
